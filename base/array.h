...
namespace array {
  template <typename T> inline T *begin(Array<T> &array) {
    return array.data;
  }
  template <typename T> inline const T *begin(const Array<T> &array) {
    return array.data;
  }
  template <typename T> inline T *end(Array<T> &array) {
    return array.data + array.size;
  }
  template <typename T> inline const T *end(const Array<T> &array) {
    return array.data + array.size;
  }

  template <typename T> inline bool empty(const Array<T> &array) {
    return array.size == 0;
  }
  template <typename T> inline bool any(const Array<T> &array) {
    return array.size != 0;
  }
